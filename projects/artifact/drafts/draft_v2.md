...
- Rationale: 明確、簡便與標準化的補償處理機制及資料保存可保障消費者、外送員及平台權益，並符合法規及主管機關查核要求。
- Source: URL-4, R2-M3, URL-29, URL-34
- Acceptance Criteria:
...
- Rationale: 保障外送員收入與工作機會，降低排擠爭議，並符合法律公平交易及主管機關查核要求。
- Source: URL-10, R2-M2
- Acceptance Criteria:
...
- Rationale: 確保外送員善意異常上報不致受報復或不當懲處，提升持續合作意願與平台公信力。
- Source: URL-25, R2-M2
- Acceptance Criteria:
...
### REQ-30: 特殊取餐地點揭露、同意取得及資料保存限制
- Type: constraint
- Description: 當消費者於下單流程指定特殊取餐地點（如校園、醫院、商辦大樓等），平台必須明確揭露該地點進出限制、現場規範、隱私政策、風險與責任條款，並於訂單成立前取得消費者同意。必要時，應提示消費者補充臨時聯絡人或門禁資訊。所有用戶同意、聯絡及配送進出紀錄，須依主管機關規定保存至少二年，於查核或爭議時應能出具完整證明資料。
- Rationale: 明確資訊揭露與同意取得，以及保存查核用資料，有助於控管平台法律責任並符合法規要求。
- Source: URL-36, R2-M1
- Acceptance Criteria:
  - 消費者選擇特殊取餐地點時，平台介面明確揭露進出限制、規範、風險及隱私條款。
  - 下單前必須要求消費者明確同意條款，必要時收集臨時聯絡人或門禁資訊。
  - 所有同意、聯絡及配送進出資料保存不少於二年，能於主管機關查核或發生爭議時提送完整證明。
- Risks:
  - 紀錄保存缺漏、揭露不全或個資外洩將導致主管機關查核不符或信任風險。
- Assumptions:
  - 部分特殊場所若有法規例外，可於後續細化補充。
  - 必要提示之揭露內容及同意保存期限於介面明確顯示。
...
- Type: constraint
- Description: 所有賠償申請、處理回報、審查紀錄、補償決策及決策依據等資料，應保存不少於二年，並於主管機關、權益人查詢、稽核或調查時可供即時查調。
- Rationale: 符合法規對舉證、查核要求並確保日後消費爭議、主管機關查核時有完整證明。
- Source: URL-4, R2-M3, URL-29, URL-34
- Acceptance Criteria:
